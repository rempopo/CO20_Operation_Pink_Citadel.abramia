...
MissionCondition1 = [ "WIN", { 
	!alive tgt_aa_1 && !alive tgt_aa_2 
	&& !alive AmbientArtyBattery1 && !alive AmbientArtyBattery2 
	&& !alive tgt_armor_1 && !alive tgt_armor_2 && !alive tgt_armor_3 && !alive tgt_armor_4
}, "All objectives done" ];
